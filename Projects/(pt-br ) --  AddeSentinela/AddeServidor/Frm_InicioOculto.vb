...
Public Class Frm_InicioOculto
    ...
    Private Sub Frm_InicioOculto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            ''coloca no inicio, notifica, envia email ou configura
            ColocaNoLogin()
            Notificação("Inicio")
            EnviaEmail()
    ...
    Public Sub EnviaEmail()
        ...
        Try
            ...
            mail.Body = GetCurrent.Name & " foi acessado às " & Now
            mail.Subject = "Acesso ao " & GetCurrent.Name
    ...
    Public Sub Notificação(ByVal Qual As String)
        ...
        Try
            ...
            If Qual = "Final" Then
                NotifyIcon1.BalloonTipTitle = "Informação"
                NotifyIcon1.BalloonTipText = GetCurrent.Name & " foi acessado às " & Now & ". Notificação encaminhada por email."
                NotifyIcon1.BalloonTipIcon = ToolTipIcon.Info
                NotifyIcon1.ShowBalloonTip(50000)
            End If
